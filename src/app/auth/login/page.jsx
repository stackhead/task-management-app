...
function LoginContent() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Add a small delay before redirecting to show the loading state
      setTimeout(() => {
  ...
  // Show full-screen loading when redirecting to dashboard
  if (isRedirecting) {
    return (
      <div className="fixed inset-0 bg-gradient-to-br from-indigo-50 to-blue-100 flex flex-col items-center justify-center z-50">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-gray-800 mb-2">Redirecting to Dashboard</h2>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 flex flex-col ">
      <div className="flex flex-row justify-between items-center px-4">
        <Image src={"/svgs/logo.svg"} alt="Logo" width={200} height={200} />
